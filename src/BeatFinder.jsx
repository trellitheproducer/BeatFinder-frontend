...
// =============================================================================
const ARTISTS_USA = [
  {id:"21savage",     name:"21 Savage",       cat:"Rap",    flag:"🇺🇸"},
  {id:"drake",        name:"Drake",            cat:"Rap",    flag:"🇺🇸"},
  {id:"future",       name:"Future",           cat:"Rap",    flag:"🇺🇸"},
  {id:"gunna",        name:"Gunna",            cat:"Rap",    flag:"🇺🇸"},
  {id:"juicewrld",    name:"Juice WRLD",       cat:"Rap",    flag:"🇺🇸"},
  {id:"kanye",        name:"Kanye West",       cat:"Rap",    flag:"🇺🇸"},
  {id:"kendrick",     name:"Kendrick Lamar",   cat:"Rap",    flag:"🇺🇸"},
  {id:"lilbaby",      name:"Lil Baby",         cat:"Rap",    flag:"🇺🇸"},
  {id:"lildurk",      name:"Lil Durk",         cat:"Rap",    flag:"🇺🇸"},
  {id:"liluzivert",   name:"Lil Uzi Vert",     cat:"Rap",    flag:"🇺🇸"},
  {id:"metroboomin",  name:"Metro Boomin",     cat:"Rap",    flag:"🇺🇸"},
  {id:"playboicarti", name:"Playboi Carti",    cat:"Rap",    flag:"🇺🇸"},
  {id:"travis",       name:"Travis Scott",     cat:"Rap",    flag:"🇺🇸"},
  {id:"youngthug",    name:"Young Thug",       cat:"Rap",    flag:"🇺🇸"},
  {id:"nba",          name:"NBA YoungBoy",     cat:"Rap",    flag:"🇺🇸"},
  {id:"cardib",       name:"Cardi B",          cat:"Rap",    flag:"🇺🇸"},
  {id:"nickiminaj",   name:"Nicki Minaj",      cat:"Rap",    flag:"🇺🇸"},
  {id:"eminem",       name:"Eminem",           cat:"Rap",    flag:"🇺🇸"},
  {id:"jcole",        name:"J. Cole",          cat:"Rap",    flag:"🇺🇸"},
  {id:"meekmill",     name:"Meek Mill",        cat:"Rap",    flag:"🇺🇸"},
  {id:"postmalone",   name:"Post Malone",      cat:"Rap",    flag:"🇺🇸"},
  {id:"rodwave",      name:"Rod Wave",         cat:"Rap",    flag:"🇺🇸"},
  {id:"polo",         name:"Polo G",           cat:"Rap",    flag:"🇺🇸"},
  {id:"theweeknd",    name:"The Weeknd",       cat:"R&B M",  flag:"🇺🇸"},
  {id:"brysonti",     name:"Bryson Tiller",    cat:"R&B M",  flag:"🇺🇸"},
  {id:"chrisb",       name:"Chris Brown",      cat:"R&B M",  flag:"🇺🇸"},
  {id:"usher",        name:"Usher",            cat:"R&B M",  flag:"🇺🇸"},
  {id:"frankocean",   name:"Frank Ocean",      cat:"R&B M",  flag:"🇺🇸"},
  {id:"andersonpaak", name:"Anderson .Paak",   cat:"R&B M",  flag:"🇺🇸"},
  {id:"giveon",       name:"Giveon",           cat:"R&B M",  flag:"🇺🇸"},
  {id:"brentfaiyaz",  name:"Brent Faiyaz",     cat:"R&B M",  flag:"🇺🇸"},
  {id:"dvsn",         name:"dvsn",             cat:"R&B M",  flag:"🇺🇸"},
  {id:"beyonce",      name:"Beyonce",          cat:"R&B F",  flag:"🇺🇸"},
  {id:"sza",          name:"SZA",              cat:"R&B F",  flag:"🇺🇸"},
  {id:"her",          name:"H.E.R.",           cat:"R&B F",  flag:"🇺🇸"},
  {id:"summerwalker", name:"Summer Walker",    cat:"R&B F",  flag:"🇺🇸"},
  {id:"keyshia",      name:"Keyshia Cole",     cat:"R&B F",  flag:"🇺🇸"},
  {id:"jhene",        name:"Jhene Aiko",       cat:"R&B F",  flag:"🇺🇸"},
  {id:"arianag",      name:"Ariana Grande",    cat:"R&B F",  flag:"🇺🇸"},
  {id:"aliciakeys",   name:"Alicia Keys",      cat:"R&B F",  flag:"🇺🇸"},
  {id:"dojacat",      name:"Doja Cat",         cat:"R&B F",  flag:"🇺🇸"},
  {id:"bigsean",      name:"Big Sean",         cat:"Detroit",flag:"🇺🇸"},
...
const ARTISTS_UK = [
  {id:"ajtracey",      name:"AJ Tracey",       cat:"UK Rap", flag:"🇬🇧"},
  {id:"aitch",         name:"Aitch",           cat:"UK Rap", flag:"🇬🇧"},
  {id:"centralcee",    name:"Central Cee",     cat:"UK Rap", flag:"🇬🇧"},
  {id:"dblockeurope",  name:"D-Block Europe",  cat:"UK Rap", flag:"🇬🇧"},
  {id:"dave",          name:"Dave",            cat:"UK Rap", flag:"🇬🇧"},
  {id:"diggad",        name:"Digga D",         cat:"UK Rap", flag:"🇬🇧"},
  {id:"headieone",     name:"Headie One",      cat:"UK Rap", flag:"🇬🇧"},
  {id:"jhus",          name:"J Hus",           cat:"UK Rap", flag:"🇬🇧"},
  {id:"ktrap",         name:"K-Trap",          cat:"UK Rap", flag:"🇬🇧"},
  {id:"potterpayper",  name:"Potter Payper",   cat:"UK Rap", flag:"🇬🇧"},
  {id:"skepta",        name:"Skepta",          cat:"UK Rap", flag:"🇬🇧"},
  {id:"stormzy",       name:"Stormzy",         cat:"UK Rap", flag:"🇬🇧"},
  {id:"slowthai",      name:"Slowthai",        cat:"UK Rap", flag:"🇬🇧"},
  {id:"ghetts",        name:"Ghetts",          cat:"UK Rap", flag:"🇬🇧"},
  {id:"giggs",         name:"Giggs",           cat:"UK Rap", flag:"🇬🇧"},
  {id:"dizzee",        name:"Dizzee Rascal",   cat:"UK Rap", flag:"🇬🇧"},
  {id:"wiley",         name:"Wiley",           cat:"UK Rap", flag:"🇬🇧"},
  {id:"jme",           name:"JME",             cat:"UK Rap", flag:"🇬🇧"},
  {id:"kano",          name:"Kano",            cat:"UK Rap", flag:"🇬🇧"},
  {id:"ninesuk",       name:"Nines",           cat:"UK Rap", flag:"🇬🇧"},
  {id:"mostack",       name:"MoStack",         cat:"UK Rap", flag:"🇬🇧"},
  {id:"fredo",         name:"Fredo",           cat:"UK Rap", flag:"🇬🇧"},
  {id:"arrdee",        name:"ArrDee",          cat:"UK Rap", flag:"🇬🇧"},
  {id:"tion",          name:"Tion Wayne",      cat:"UK Rap", flag:"🇬🇧"},
  {id:"stefflon",      name:"Stefflon Don",    cat:"UK Rap", flag:"🇬🇧"},
  {id:"ladyleshurr",   name:"Lady Leshurr",    cat:"UK Rap", flag:"🇬🇧"},
  {id:"missdynamite",  name:"Ms Dynamite",     cat:"UK Rap", flag:"🇬🇧"},
  {id:"craigdavid",    name:"Craig David",     cat:"UK R&B", flag:"🇬🇧"},
  {id:"jorja",         name:"Jorja Smith",     cat:"UK R&B", flag:"🇬🇧"},
  {id:"rayblk",        name:"Ray BLK",         cat:"UK R&B", flag:"🇬🇧"},
  {id:"mahalia",       name:"Mahalia",         cat:"UK R&B", flag:"🇬🇧"},
  {id:"pinkpantheress",name:"PinkPantheress",  cat:"UK R&B", flag:"🇬🇧"},
  {id:"samsmith",      name:"Sam Smith",       cat:"UK R&B", flag:"🇬🇧"},
  {id:"raye",          name:"RAYE",            cat:"UK R&B", flag:"🇬🇧"},
...
// AVATAR
// =============================================================================
function Av({ name, size = 88, idx = 0 }) {
  ...
  return (
    <div style={{ padding: "0 0 100px" }}>
      ...
      <div style={{
        ...
        <Av name={artist.name} size={72} idx={idx >= 0 ? idx : 0} />
        <div>
